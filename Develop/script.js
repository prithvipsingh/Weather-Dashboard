...
function getCurrent(city) {
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + city + "&APPID=ffae41c982541a1db59e191fd320fdb3";
    $.ajax({
        url: queryURL,
        method: "GET",
        error: function (){
...
function getForecast(city) {
    //get 5 day forecast
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?id=" + city + "&APPID=ffae41c982541a1db59e191fd320fdb3";
    $.ajax({
        url: queryURL,
        method: "GET"
    }).then(function (response) {
