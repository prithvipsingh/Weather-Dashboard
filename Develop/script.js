...
// store api key
var apiKey = "&appid=3e8e6b66d0b079dc2fe7f3dddc02e551";
// create variable for date
var date = new Date();
// keypress function for searchbutton
...
$("#searchBtn").on("click", function () {
  ...
  // full url to call api for current city weather 
  const queryUrl =
...
// function for adding history of search cities.
function makeList() {
...
// create function for current city 
function getCurrentConditions(response) {
  ...
  const cityDate = $("<h4>")
    .addClass("card-title")
    .text(date.toLocaleDateString("en-aedt"));
  const temperature = $("<p>")
